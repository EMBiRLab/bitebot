function [filename, confirmation_array, cal_domain, strict_cal_domain, zero_domain, golay_framelen] = import_resense_data(combination)
    filename = "";
    confirmation_array = [];
    cal_domain = [];
    strict_cal_domain = [];
    ...
    switch combination
        ...
        case 'S21_Y0_R2_T1'
            confirmation_array = [];
            filename = 'hex21_data/h21_static_n2_t1.csv';
            cal_domain = 1e3:11e3;
        ...
        case 'S21_Y1_R2_T1'
            ...
            filename = 'hex21_data/h21_manual_n2_t1.csv';
            cal_domain = 4e3:11e3;
        ...
        case 'S21_Y0_R3_T1'
            confirmation_array = [];
            filename = 'hex21_data/h21_static_n3_t1.csv';
            cal_domain = 4e3:11e3;
            strict_cal_domain = 6e3:8e3;
        ...
        case 'S21_Y1_R3_T1'
            confirmation_array = 1:10;
            filename = 'hex21_data/h21_manual_n3_t1.csv';
            cal_domain = 100e3:110e3;
            strict_cal_domain = 103e3:105e3;

        case 'S21_Y1_R3_T2'
            confirmation_array = [];
            filename = 'hex21_data/h21_manual_n3_t2.csv';
            cal_domain = 1e3:10e3;
            strict_cal_domain = 53e3:9e3;

        case 'S21_Y1_R3_T3'
            confirmation_array = 1:10;
            filename = 'hex21_data/h21_manual_n3_t3.csv';
            cal_domain = 4e3:11e3;
        ...
        case 'S21_Y1_R3_T4'
            confirmation_array = 1:10;
            filename = 'hex21_data/h21_manual_n3_t4.csv';
            cal_domain = 4e3:11e3;
            strict_cal_domain = 6e3:9e3;
